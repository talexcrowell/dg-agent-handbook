    ...
    >
      <Grid.Col span={12}>
        <Stack>
          ...
          <Text>
            <Text fw={700}>Recommended Stats:</Text>Some professions require
          ...
          <Text>
            <Text fw={700}>Recommended Skills:</Text>Each profession has a
            predefined kit of skills with scores that replace the default skill
            ratings. This represents the baseline training and education for
            that profession.
          </Text>
          <Text>
            <Text fw={700}>Bonds:</Text> Each profession dictates the number of
            Bonds your Agent begins with. Difficult and trying professions mean
            fewer Bonds but more skills.
          </Text>
          <Text>
            <Text fw={700}>Bonus Skill Points:</Text>Pick any eight skills and
            add 20 points to each. If it’s not a professional skill, add the 20
            to its base rating. You can also instead select from Bonus Skill Packages to fit
            to your Agent's hobbies and/or background. This allows your Agent to
            specialize in certain professional skills or to learn a little about
            skills not included in his or her profession.
          </Text>
          <Space />
          <Space />
          <Space />
