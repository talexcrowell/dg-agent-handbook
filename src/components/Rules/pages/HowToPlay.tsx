        ...
        <Stack>
              ...
              <Table withTableBorder withColumnBorders w={325} striped>
                ...
                <Table.Tbody>
                  ...
                  <Table.Tr>
                    ...
                    <Table.Td>
                      <Text>
                        Circumstances are distinctly worse than usual.
                      </Text>
                    </Table.Td>
                  </Table.Tr>
                  <Table.Tr>
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              It takes a few combat turns or, at most, sixty seconds. Combat,
              some skill tests, and most stat tests are resolved in turns.
            </Text>
            <Text>
              <Text fw={700} span>
                Minutes:
              ...
              your Agent can get through it rapidly. Many skill tests are
              resolved in minutes.
            </Text>
            <Text>
              <Text fw={700} span>
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              maneuverable grants a +20% bonus to each chase test, or +40% if
            ...
            <Text>
              ...
              Instead of the usual roll to catch up or get away, pursuer or
              quarry may attempt to gain some advantage by testing a skill that
              applies to the situation, such as Alertness, Navigate, Stealth,
              Survival, or Tactics. If this test wins the contest, neither side
              gains a “win” but it grants a +20% bonus to that character’s next
              chase roll, or +40% with a critical success. Failure and fumbling
            ...
            <Text>
              ...
              before the pursuer and quarry roll to pursue and escape.Each
              contest in the chase is equivalent to one combat turn. If your
              Agent is the driver or is on foot, attacking instead of rolling to
              pursue or escape means the opponent’s roll to pursue or escape
              automatically wins.
            </Text>
          </Stack>
          <Divider />
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              for 1D6 hours. Harder, illegal drugs offset it for 2D6 hours.
              During this time, your Agent can’t sleep. An Agent can take more
              stimulants to keep going, but every dose after the first costs 1D6
              WP. Stimulants never restore WP. If your Agent gains a new
              disorder while using stimulants, the Handler has good reason to
              say the disorder takes the form of addiction to them.
            </Text>
          </Stack>
          <Stack gap="xs">
            ...
            <Text>
              ...
              trauma. This gives a +20% bonus to the SAN test to get to sleep.
              If the test fails, the Agent gets no rest despite taking
              sedatives. In addition, the Agent is sick the next day, at a −20%
              penalty to all tests until he or she gets a full night’s rest. If
              your Agent gains a new disorder while using sedatives, the Handler
              has good reason to say the disorder takes the form of an addiction
              to them.
            </Text>
          </Stack>
          {viewport.width > 760 &&
