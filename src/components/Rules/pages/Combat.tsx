        ...
        <Stack>
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              High or low Strength modifies the damage of hand-to-hand attacks,
              to a minimum of 0
            </Text>
            <Text>
              <Text fw={700} span>
              ...
              you may attempt a CON×5 test to recover and act normally next
              turn. If any single attack inflicts half of your Agent’s current
              HP, the Agent is stunned.
            </Text>
            <Text>
              <Text fw={700} span>
                Unconsciousness:
              ...
              unconscious. An unconscious Agent is helpless and can be killed
              with a single attack without having to roll. At 3 HP or more (or
              after an hour passes), the Agent regains consciousness.
            </Text>
            <Text>
              <Text fw={700} span>
                Permanent Injury:
              </Text>{" "}
              Any time your Agent is reduced to 2 or fewer HP, make a CON×5
              test. Failure indicates permanent injury. The Handler selects a
              stat to be permanently reduced by the number on the lowest
              ten-sided die of the failed CON×5 roll, to a minimum score of 3.
              If STR or CON drop, adjust HP accordingly.
            </Text>
            <Text>
              <Text fw={700} span>
                Death:
              </Text>{" "}
              If an attack brings your Agent to 0 HP, he or she is dead. HP do
              not go below 0.
            </Text>
          </Stack>
          <Stack gap="xs">
            ...
            <Text>
              ...
              healed; a fumble inflicts 1D4 damage. Once your Agent receives
              first aid, success or failure, the Agent can’t benefit from it
            ...
            <Text>
              ...
              Handler’s discretion, having less extensive tools and medicines
              may incur a penalty.
            </Text>
            <Text>
              <Text fw={700} span>
              ...
              safe place with proper food and water can attempt a CON×5 test
              once per day to recover 1 HP (in addition to any HP recovered due
              to medical treatment). On a critical success, the patient regains
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              Rating. Body armor protects against the damage of a failed
              Lethality roll, but does nothing whatsoever against a successful
              Lethality roll.
            </Text>
            <Text>
              <Text fw={700} span>
              ...
              Finding cover means using a hard bar- rier as armor against
              attack. Cover protects more completely than body armor. If you
              have cover against a Lethality attack, the Lethality roll
              automatically fails, but still inflicts the sum of the dice as
              damage. Subtract the cover’s Armor rating from that damage. What
              if your Agents are completely enclosed in a structure or vehicle?
              That’s definitely cover, but it’s the Handler’s call. Maybe they
              take damage reduced by the cover, or maybe they take no damage
              until the cover is breached.
            </Text>
          </Stack>
          <Stack gap="xs">
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              Diseases inflict HP damage. If your Agent succeeds at a CON×5
              test, he or she suffers half damage and recovers from the disease,
              or no damage with a critical success. On a failure, he or she
              suffers full damage and must make the CON×5 test again after
              another Speed interval. A fumbled CON test doubles the damage.
              While under the effects of a disease, the Agent cannot gain Hit
              Points back. Hospitalization grants a +20% bonus to the CON test.
            </Text>
            <Text>
            ...
            <Text>
              ...
              physician has the antidote for a poison or the right antibiotics
              for a disease, a Medicine or Pharmacy test before the ailment
              takes effect renders the poison or disease harmless. An antidote
              given after the ailment takes effect halves the Lethality rating
              and the HP damage.
            </Text>
          </Stack>
          <Stack gap="xs">
            ...
            <Text>
              ...
              1D6 damage, or 2D6 if it’s a particularly uncontrolled fall.
