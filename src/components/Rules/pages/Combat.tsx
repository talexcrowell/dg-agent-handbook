      ...
      <Grid.Col span={12}>
        <Stack>
          ...
          <Text>
            ...
            the bulldozer razing the field the ant hill stands in. Combat rarely
          ...
          <Text>
            Combat is measured in turns. A turn is a few seconds, or as long as
            it takes everyone to complete a single action.
          </Text>
          <Text>
            The Handler counts down by DEX for all characters, from highest to
            lowest. Each character acts when his or her number comes up. If DEX
            scores tie, the actions occur at the same time or the Handler can
          ...
          <Text>
            ...
            a skill test to see if your Agent hits a target, damage is inflicted
            based on the weapon used. Usually it’s Firearms for a gun, Athletics
            for a thrown weapon, Melee Weapons for a hand-to-hand weapon, or
            Unarmed Combat for a punch or kick.
          </Text>
          <Text>
            The number of shots fired in a single firearm attack depends on the
            weapon used—a bolt-action rifle fires one bullet while a
          ...
          <Text>
            ...
            past cover or to shoot someone in the leg in order to avoid body
            armor. If the attack is automatic gunfire that can hit multiple
          ...
          <Text>
            ...
            attack roll. If your roll overcomes the attack roll, your Agent
          ...
          <Text>
            ...
            against your Agent. If the pinning character is not attacking, the
            escape is opposed by either Unarmed Combat or STR×5 (whichever is
            better). If the escape roll succeeds, your Agent is no longer pinned
            and the escape roll acts as a defense roll against all attackers. If
          ...
          <Text>
            ...
            about 3 meters while performing some other action).
          </Text>
          <Text>
          ...
          <Text>
            If there’s cover at the end of your Agent’s movement, getting behind
            it provides protection. This can give your Agent armor against
            firearms and explosives—if the Agent is behind cover when the attack
          ...
          <Text>
            All unarmed or melee weapon attacks against a pinned target are at a
            +20% bonus. An Agent pinning a target can attack the pinned target
            in later turns.
          </Text>
          <Text>
          ...
          <Text>
            ...
            Agent’s action before the next action in DEX order. Your Agent can’t
            wait until another character acts and then jump in before it’s
          ...
          <Text>
            An attack is a skill roll which inflicts damage, disarms or pins the
            target, depending on the attacker’s action. An attack roll that’s a
            critical success is a critical hit. A critical hit inflicts double
            damage. An attack roll that fumbles includes a complication
          ...
          <Text>
            ...
            your Agent’s single action for that turn. An Agent who has already
            taken another action that turn can’t Dodge or fight back until the
            next turn.
          </Text>
          <Text>
            A roll to Dodge opposes all hand-to-hand attacks that turn. It lets
            your Agent duck behind cover to evade all ranged attacks that turn
            if cover is near. Dodging never inflicts damage.
          </Text>
          <Text>
            Fighting back opposes all hand-to-hand attacks that turn. If you win
            the contest, you take no damage. It does not protect you against
            ranged attacks unless you’re close enough to push the ranged weapon
            away. As part of your fighting back roll, choose one offensive
            action—attack, called shot, disarm, or pin— against a single
            attacker. If your roll beats that attacker’s roll, your Agent takes
            no damage and your Agent’s action affects the attacker instead.
          </Text>
          <Text>
            In order to Dodge or fight back, your Agent must know an attack is
            coming and be physically able to block or evade it. If your Agent is
            pinned, if the attack occurs before he or she realizes it, or if
          ...
          <Text>
            ...
            Dodge to scramble for cover. If your Agent is near enough to move to
            cover and knows gunfire or an explosion is imminent, make a Dodge
            roll for the Agent to get behind the cover. If there’s no cover,
          ...
          <Text>
            ...
            or pin only one target a turn (the attack might hurt others, but all
            attacks have a single target).
          </Text>
          <Text>
            ...
            until your Agent’s next action. If an attack fails to overcome your
            roll, it does no harm.
          </Text>
          <Text>
            To oppose an attack, your Agent must know the attack is coming. That
            requires seeing or hearing the attacker. The Agent must also be
            physically able to block the Attack, if it is melee. A pinned Agent
            can’t defend, nor can an Agent who has already successfully pinned a
            target.
          </Text>
          <Text>
          ...
          <Text>
            Each weapon or attack has a damage rating measured in dice. When an
            attack hits, roll the weapon’s damage dice and subtract the result
          ...
          <Text>
            ...
            immediately drops to 0 HP. If the Lethality test fails, add the two
            dice together as if they were individual D10s (0 is 10) and apply
            that as HP damage.
          </Text>
          <Text>
            Lethality rolls do not fumble or critically succeed, but the attack
            roll can. If the attack roll is a critical success, double the
          ...
          <Text>
            A failed attack roll means the Kill Radius lands harmlessly outside
            the intended area. The attack does no harm but it may still suppress
            targets. Whether a failed Kill Radius attack does unwanted
          ...
          <Text>
            ...
            NPCs to speed things up. But really, you need to roll Lethality only
            for characters who are important enough to track in detail. Since
            even a failed Lethality roll inflicts between 2 and 20 damage, it’s
          ...
          <Text>
            ...
            nervous system forces him or her to go to ground. Your Agent must
            either find cover or go prone as his or her next action. Your Agent
            can stifle his or her terror and act normally at a cost of 1 SAN.
          </Text>
          <Text>
          ...
          <Text>
            A character adapted to violence loses no SAN for braving suppressing
            fire. For NPCs, it’s easiest to assume the average human goes to
          ...
          <Text>
            ...
            trigger can fire a single shot, a short burst, a long burst, a short
            spray, or a long spray. A weapon set for single shots attacks
            normally. A burst or a spray has a Lethality rating.
          </Text>
          <Text>
            A short burst fires three bullets in one trigger pull. It affects a
            single target. A long burst fires five shots with a Kill Radius of 1
            meter. Short and long sprays empty the magazine faster but cover a
          ...
          <Text>
            ...
            can do this, but it takes longer. Large objects have Hit Points as
            described in the Equipment section and they are considered huge
            targets.
          </Text>
          <Divider />
          <Title order={2} td="underline">
          ...
          <Text>
            Armor comes in two forms: body armor and cover. They both reduce the
            damage of ordinary attacks, but have different effects on Lethality
            attacks. If you have more than one source of armor (such as wearing
          ...
          <Text>
            ...
            persistent disease—such as HIV/AIDS—means succeeding at the CON test
            only buys time; the disease subsides and your Agent recovers lost
            HP. But every time the Agent is badly hurt (losing more than half
            his or her HP) or suffers from some other poison or disease, the
          ...
          <Text>
            ...
            turns. After that, your Agent’s oxygen-starved brain begins to die.
            Once every turn, make a CON×5 test. If it fails, your Agent suffers
            1D6 HP damage. If the CON test succeeds, your Agent suffers 1 HP
            damage instead. This continues until your Agent can breathe again or
            he or she dies.
          </Text>
          <Text>
          ...
          <Text>
            ...
            and well equipped (decked out for an Arctic expedition, for example)
            Agents can last CON hours.
          </Text>
          <Text>
            ...
            Agent’s CON hits 1, the Agent can no longer move and suffers 1D8 HP
            cold damage every five minutes.
          </Text>
          <Text>
