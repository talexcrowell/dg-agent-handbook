        ...
        <Stack>
          <Stack gap="xs">
            ...
            <Text>
              ...
              conspiracy. It’s about men and women making awful choices and
              doing terrible things to prevent far worse horrors: incursions of
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              chats. One person is the Handler, they're responsible for
              presenting and managing the game. The other players take the role
              of Agents of a secret organization called "Delta Green".
            </Text>
            <Text>
            ...
            <Text>
              As the Handler and Agents continue this cooperative dialogue and
              the mystery of the Operation unravels, a narrative emerges. A
              narrative of horror, dread, secrets, and terrible consequences.
            </Text>
          ...
          <Stack gap="xs">
            ...
            <Text>
              The Handler will organize and prepare the game in the venue of
              their choice. They will act as a resource for the players for any
              major questions about the game.
            </Text>
            <Text>
              Although the Handler will help guide you through your first
              Operation, there are some tasks that can help improve and
              streamline the playing experience:
            </Text>
            <List>
              <List.Item>
              ...
              <List.Item>
                Review the basic rules and ask the Handler for any
                clarifications.
              </List.Item>
            </List>
            <Text>
