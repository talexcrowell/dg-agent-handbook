      ...
      <Grid.Col span={12}>
        <Stack>
          <Stack gap="xs">
            ...
            <Text>
              Willpower represents your mental fortitude and can be used
              sparingly to protect your sanity at a cost to you and a loved one.
              It can even be used for unnatural rituals.
            </Text>
          </Stack>
          <Divider />
          <Stack gap="xs">
            ...
            <Text>
              ...
              or Fighting Back. This can happen before your Agent's postion in
              the DEX order and count as your Agent's action for this turn. If
              an Agent has already taken their turn, they can't act defensively.
            </Text>
            <Text>
            ...
            <Text>
              ...
              Opposes all hand-to-hand attacks that turn and let your Agents
              duck behind cover to evade ranged attacks that turn. Dodging
              protects against each attack that your roll beats. Dodging never
              inflicts damage.
            </Text>
            <Text>
              <Text fw={700}>Attacking or Fighting Back:</Text>
              Opposes each hand-to-hand attack that turn. This cannot protect
              against ranged attacks unless your Agent physically interferes
              with the weapon. When fighting back, choose an offensive action:
              attack, called shot, disarm, or pin. If your roll beats the
              attack, the attacker’s action has no effect and your Agent’s
              action affects the attacker. While the roll defends against all
              attackers, the offensive action affects only a single target.
            </Text>
          </Stack>
          <Stack gap="xs">
            ...
            <Text>
              A successful attack inflicts damage, which reduces the victim’s
              Hit Points. Damage depends on the weapon.
            </Text>
            <Text>
              At 2 HP or below, your Agent falls unconscious for an hour or
              until healed to 3 HP.
            </Text>
            <Text>
          ...
          <Stack gap="xs">
            ...
            <Text>
              Each threat comes with two possible SAN losses, one more severe
              than the other. When your Agent faces one of those threats, make a
              SAN roll. That means rolling your Agent’s current SAN or lower on
              percentile dice. If you succeed, your Agent suffers the lower
              loss; with a critical success, your Agent suffers the minimum loss
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              Agent snaps out of it; usually that’s a few minutes after the
            ...
            <Text>
              ...
              Breaking Point to its new value: your Agent’s current SAN minus
              POW. The Handler will determine the details of your Agent’s new
              disorder later in the operation or perhaps in between this
              operation and the next.
            </Text>
            <Text>
              <Text fw={700}>Permanent Insanity:</Text>
              If your Agent’s SAN reaches 0, your Agent goes irretrievably
              insane. The Agent becomes a Handler character and it’s time to
              make up a new one.
            </Text>
            <Title order={3} style={{ scrollMarginTop: 80 }}>
            ...
            <Text>
              ...
              projecting it onto a crucial personal relationship, damaging a
              Bond. Spend 1D4 WP. If your Agent still has at least 1 WP, reduce
              the SAN loss by the amount of WP spent (to a minimum of zero) and
              reduce a Bond’s score by the same amount.
            </Text>
            <Text>
              The next time your Agent interacts with that Bond, decide what
              shape the damage takes. Does your Agent grow hostile and angry,
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              insane becomes adapted. If your Agent loses SAN due to
              Helplessness or Violence, check one of the three boxes for that
              threat on the character sheet under INCIDENTS OF SAN LOSS WITHOUT
              GOING INSANE. If your Agent goes insane or reaches the Breaking
              Point due to that threat, erase all its checks. If you check all
              three boxes for a threat, your Agent becomes adapted to that
              threat. When adapted to a threat, an Agent’s SAN tests for it
              always succeed— but adapting to a threat changes your Agent, and
              not for the better. No Agent can adapt to the Unnatural.
            </Text>
          </Stack>
          <Stack gap="xs">
            <Title order={3} style={{ scrollMarginTop: 80 }}>
            ...
            <Text>
              When suffering temporary insanity or an acute episode of a
              disorder, your Agent can try to repress it by focusing on the
              people who depend on him or her. Spend 1D4 WP, and reduce one Bond
              by the same amount. Now you may attempt a SAN test. If it
              succeeds, your Agent stifles the symptoms of insanity, and you
              retain control of your character after all. The next time your
              Agent interacts with that Bond, describe how the relationship has
              worsened.
            </Text>
          </Stack>
          <Stack gap="xs">
          ...
          <Stack gap="xs">
            ...
            <Text>
              Agents need Willpower points (WP) to withstand exhaustion and
              mental trauma, to resist interrogation and persuasion, and to
              enact unnatural rituals.
            </Text>
          </Stack>
          <Stack gap="xs">
            <Title order={3} style={{ scrollMarginTop: 80 }}>
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              insanity or reaching the Breaking Point, you must make a Sanity
              test for the Agent to get any rest. After failing to get a good
              night’s sleep, or working CON in hours without a break, an Agent
              loses 1D6 WP and become exhausted. An exhausted Agent suffers a
              –20% penalty to all skills, stat tests, and SAN rolls. A full
