      ...
      <Grid.Col span={12}>
        <Stack>
          ...
          <Text>
            ...
            practice, it is never that simple. There are many types of Delta
          ...
          <Text>
            ...
            surround the unnatural are beyond even the most hardened agents. Yet
            someone must confront them. Physical threats are only half the
          ...
          <Text>
            ...
            for others. Sometimes violence is worse than useless because you’re
            up against something that transcends reality itself. It’s hard to
          ...
          <Text>
            ...
            its forms is an abyss that consumes people whole, drawing them over
            the edge into insanity. It’s a trap that will never stop attracting
            us. Wise agents quickly learn to let understanding go, except for
            the few facts required to survive.
          </Text>
          <Divider />
          <Title order={2}>Keeping Secrets</Title>
          <Text>
            Even within the pressurized folds of Delta Green there are secrets.
            Agents must keep operations from their family, their jobs, and,
            worse, from other agents. There is safety in ignorance. Agents are
            truly alone in a world that’s not nearly as well understood as the
          ...
          <Text>
            ...
            code to perform the mission and, just as important, to cover it up.
            There is no quarter taken or given. If you are arrested or
            humiliated in the media, nobody from the group can help. And if you
            reveal the group’s secrets, no mat- ter the circumstances, you
