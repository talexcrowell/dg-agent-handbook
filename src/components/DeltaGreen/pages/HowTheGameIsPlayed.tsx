        ...
        <Stack>
          ...
          <Stack gap="xs">
            ...
            <Text>
              ...
              the person running the game whether the Agent can accomplish a
              goal. When things are desperate and unpredictable, you roll dice—
              to see whether your Agent has the Strength to push open a locked
              door or can Persuade the axe-wielding maniac to let the Agent
              live.
            </Text>
            <Text>
            ...
            <Text>
              We also measure the strength of your Agent’s relationships with
              the most important people in his or her life with Bonds, which
              keep your Agent sane, but deteriorate as your Agent suffers
              trauma.
            </Text>
          </Stack>
          <Divider />
          <Stack gap="xs">
            ...
            <Text>
              ...
              that the Agents investigate. The Handler takes the role of
              everyone in the game the Agents meet (called non-player characters
              or NPCs), describes the situations they find themselves in, and
              determines if dice are rolled, which dice are rolled, and why. The
              Handler is the narrator, director, and referee; he or she shapes
              the world and how the rules work so the players can explore and
              experience it.
            </Text>
            <Text>
            ...
            <Text>
              That requires a lot of trust between the players and their
              Handler. The Handler’s Guide is devoted to helping the Handler
              construct, build, and maintain that trust. The player’s job is
              just as challenging: to bring a Delta Green Agent to life in a
              world full of unnatural mysteries.
            </Text>
            <Text>
