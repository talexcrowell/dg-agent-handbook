      ...
      <Grid.Col span={12}>
        <Stack>
          ...
          <Text>
            ...
            you’re an Agent, it is likely you have experienced the unnatural at
            least once. This inciting event is probably what brought you to the
            attention of Delta Green in the first place. A few know more. They
            suffer that knowledge like a cancer of the mind.
          </Text>
          <Text>
          ...
          <Text>
            Second, the unnatural tends to consume those that are exposed to it,
            removing the vector in the process.
          </Text>
          <Text>
          ...
          <Text>
            Finally, a handful of government agencies around the world are aware
            of these threats and actively suppress knowledge of them.
          </Text>
          <Text>
